...
print("Your mission is to survive and become the JEDI!")

#https://www.draw.io/?lightbox=1&highlight=0000ff&edit=_blank&layers=1&nav=1&title=Treasure%20Island%20Conditional.drawio#Uhttps%3A%2F%2Fdrive.google.com%2Fuc%3Fid%3D1oDe4ehjWZipYRsVfeAx2HyB7LCQ8_Fvi%26export%3Ddownload

#Write your code below this line 👇

choice1 = input("OH NO! Storm trooper is trying to catch you! you have a choice to make! type 'run' or 'fight'.\n").lower()
print('''
...
''')
if choice1 == 'fight':
    choice2 = input("YES You somehow figured out how to use the force and beat the storm trooper!! but Darth Vader felt you and he is coming for you.. go find Master Yoda and ask for help! type 'yes' to find yoda or 'no' to run and hide.\n").lower()
    print('''
 ...
 : `."-; ;  ;                  :  ;   ,/;
  ...
  :\     \  : ;             : \.-"      :
   ...
   :  "-.  "-:  ;          :/."      .'  :
    ...
    ''')
    if choice2 == 'yes':
        choice3 = input("Success! You became the Jedi! now you are ready to fight with Darth Vader!! ....He is here....what will you do?? type'fight', 'hide' or 'say hello!'\n").lower()
        print('''
                              .-.
                      |_:_|
                     /(_Y_)\
   ...
   ':           _/.--'[[[[]'--.\_
     ':        /_'  : |::"| :  '.\
      ...
      snd |     : : :_/_|  /'._\  '--|_\
        ...
        ''')
        if choice3 == 'fight':
            print("Darth Vader is defeated! You are the winner! and You just became the new Darth Vader")
        elif choice3 == 'hide':
            print("He followed you and you are defeated..... GAME OVER")
        else:
            print("He chocked you to death because he didnt like your attitude!... GAME OVER")
    else:
        print("PATIENT YOUNG ONE! GAME OVER")
else:
    print("Storm trooper shot you.....GAME OVER")